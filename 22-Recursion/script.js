...
let students = {
	...
	html: {
		...
		semi: { students: [{ name: 'test', progress: 100 }] },
	},
};

//------------------------------------------------------------------v.1

// function getTotalProfressByIteration(data) {
// 	let total = 0;
// 	let students = 0;
...
// console.log(getTotalProfressByIteration(students));

//------------------------------------------------------------------v.2 с применением рекурсии
